...
# 52 "C:\Program Files (x86)\Microchip\xc8\v2.05\pic\include\pic18f25k50.h"
...
UARTSendString(msg1,32);
flag1=0;
}
if (flag2){
sprintf(msg1,"SecondMQ_%d\0",PORTBbits.RB1);
UARTSendString(msg1,32);
flag2=0;
}
if (flag3) {
...
if (PORTBbits.RB0 & 1) data = ((data << 1) | 1);
else data = (data << 1);
while (PORTBbits.RB0 & 1);
}
return data;
